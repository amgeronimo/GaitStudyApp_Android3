...
public class ScannerActivity extends AppCompatActivity implements BleScannerFragmentAuto.ScannerCommunicationBus, ServiceConnection {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        switch(requestCode) {
            case REQUEST_START_APP:
                ((BleScannerFragmentAuto) getFragmentManager().findFragmentById(R.id.scanner_fragment)).startBleScan();
                break;
        }
